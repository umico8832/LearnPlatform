...
class ReviewAISuggestionTest {
    ...
    void generateReviewBasedSuggestionWithContext_shouldCallAiProvider() {
        ...
        verify(callGovernanceService).begin(any(), any());
        AiTestSupport.assertCall(callGovernanceService, userId, "review_based_suggestion", "SUCCEEDED");
    }
    ...
    void generateReviewBasedSuggestionStreamWithContext_shouldCallStreamApi() {
        ...
        verify(callGovernanceService).begin(any(), any());
        AiTestSupport.assertCall(callGovernanceService, userId, "review_based_suggestion_stream", "SUCCEEDED");
    }
}
