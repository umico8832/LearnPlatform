...
class SubmissionDifficultyAssessmentServiceTest {
    ...
    void setUp() {
        ...
        org.springframework.test.util.ReflectionTestUtils.setField(assessmentService, "invocationService",
                new AiInvocationService(aiProvider, callGovernanceService));
        try {
    ...
    void assessDifficulty_aiReturnsValidJson_parsesCorrectly() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 1L, "submission_difficulty_assessment", "SUCCEEDED");
    }
    ...
    void assessDifficulty_aiFails_fallbackToRuleEstimate() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 1L, "submission_difficulty_assessment", "FAILED");
    }
