...
class QuestionReviewSuggestionServiceTest {
    ...
    void generateSuggestion_aiReturnsValidJson_parsesCorrectly() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 7L, "question_re_review_suggestion", "SUCCEEDED");
    }
    ...
    void generateSuggestion_aiFails_returnsFallback() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 7L, "question_re_review_suggestion", "FAILED");
    }
