...
class PrivateExamDraftServiceTest {
    ...
    void setUp() {
        ...
        PrivateExamDraftAnswerService answerService = new PrivateExamDraftAnswerService(
                new AiInvocationService(aiProvider, callGovernanceService), callGovernanceService, dataService, objectMapper);
    ...
    void validatesAndStoresAiSuggestionWithoutMarkingQuestionReviewed() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 7L, "private_exam_answer_generation", "SUCCEEDED");
    }
