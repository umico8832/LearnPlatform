...
class SubmissionAiQualityServiceTest {
    ...
    void setUp() {
        ...
        qualityService = new SubmissionAiQualityService(new AiInvocationService(aiProvider, callGovernanceService), callGovernanceService,
    ...
    void checkQuality_aiReturnsValidJson_parsesCorrectly() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 1L, "submission_quality_check", "SUCCEEDED");
    }
    ...
    void checkQuality_aiFails_fallbackToRuleCheck() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 1L, "submission_quality_check", "FAILED");
    }
