...
class SubmissionKPTaggingServiceTest {
    ...
    void setUp() {
        ...
        org.springframework.test.util.ReflectionTestUtils.setField(kpTaggingService, "invocationService",
    ...
    void tagKnowledgePoints_aiReturnsValidJson() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 100L, "submission_kp_tagging", "SUCCEEDED");
    }
    ...
    void tagKnowledgePoints_aiFails_fallbackToKeywordMatch() {
        ...
        AiTestSupport.assertCall(callGovernanceService, 100L, "submission_kp_tagging", "FAILED");
    }
