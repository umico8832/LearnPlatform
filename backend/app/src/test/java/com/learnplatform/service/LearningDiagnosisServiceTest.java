...
class LearningDiagnosisServiceTest {
    ...
    void setUp() {
        ...
        LearningDiagnosisAiAdviceService aiAdviceService = new LearningDiagnosisAiAdviceService(
                new AiInvocationService(aiProvider, callGovernanceService), new LearningDiagnosisPromptBuilder());
    ...
    void generateAiAdviceCallsAiProviderAndLogs() {
        ...
        AiTestSupport.assertCall(callGovernanceService, USER_ID, "learning_advice", "SUCCEEDED");
    }
    ...
    void generateAiAdviceLogsOnFailure() {
        ...
        AiTestSupport.assertCall(callGovernanceService, USER_ID, "learning_advice", "FAILED");
    }
    ...
    void generateAiAdviceStreamCallsAiProviderAndLogs() {
        ...
        AiTestSupport.assertCall(callGovernanceService, USER_ID, "learning_advice_stream", "SUCCEEDED");
    }
    ...
    void generateAiAdviceStreamLogsOnFailure() {
        ...
        AiTestSupport.assertCall(callGovernanceService, USER_ID, "learning_advice_stream", "FAILED");
    }
