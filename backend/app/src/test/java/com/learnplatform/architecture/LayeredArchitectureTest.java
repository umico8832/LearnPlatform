...
class LayeredArchitectureTest {
    ...
    @ArchTest
    static final ArchRule domain_calls_must_use_governed_gateway = noClasses()
    ...
    static final ArchRule ai_core_must_not_depend_on_application = noClasses()
            ...
            .should().dependOnClassesThat().resideInAnyPackage("com.learnplatform.service..",
                    "com.learnplatform.mapper..", "com.learnplatform.entity..", "org.springframework..",
                    "com.learnplatform.controller..", "com.learnplatform.config..");
