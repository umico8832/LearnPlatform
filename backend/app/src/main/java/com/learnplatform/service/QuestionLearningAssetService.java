...
public class QuestionLearningAssetService {
    ...
    public QuestionLearningAssetService(AiInvocationService invocationService,
                                         AiConfig aiConfig,
    ...
    public QuestionLearningAssetVO generateOrGetAsset(Long questionId, AiAssetType assetType, Long userId) {
        ...
        QuestionAiAsset asset = invocationService.text("asset_" + assetType.name().toLowerCase(java.util.Locale.ROOT),
                userId, new AiService.AiPrompt(prompt.systemPrompt(), prompt.userPrompt()), content ->
                        assetType == AiAssetType.VARIANT
    ...
    public void generateAssetStream(Long questionId, AiAssetType assetType, Long userId,
        ...
        Prompt prompt = buildAssetPrompt(questionId, assetType);
        invocationService.stream("asset_" + assetType.name().toLowerCase(java.util.Locale.ROOT) + "_stream", userId,
                new AiService.AiPrompt(prompt.systemPrompt(), prompt.userPrompt()), chunk -> {
