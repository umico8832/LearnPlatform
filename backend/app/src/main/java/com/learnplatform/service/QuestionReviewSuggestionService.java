...
public class QuestionReviewSuggestionService {
    ...
    public QuestionReviewSuggestionService(AiInvocationService invocationService,
    ...
    public QuestionReviewSuggestionVO generateSuggestion(Long questionId, Long reviewerId) {
        ...
        try {
            String aiContent = invocationService.text("question_re_review_suggestion", reviewerId,
