...
public class PrivateExamDraftAnswerService {
    ...
    public PrivateExamDraftAnswerService(AiInvocationService invocationService,
    ...
    public PrivateExamDraftVO generate(Long draftId, Long questionId, Long userId) {
        ...
        return invocationService.text("private_exam_answer_generation", userId,
                new AiService.AiPrompt(systemPrompt(), userPrompt(question)), response -> {
