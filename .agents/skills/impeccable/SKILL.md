---
name: impeccable
description: Use only when the user explicitly invokes Impeccable, such as `$impeccable`, `run Impeccable`, or an Impeccable command workflow. Retains the full upstream design, critique, audit, polish, hardening, optimization, adaptation, motion, typography, layout, live-browser, and design-system capabilities for frontend interfaces. For ordinary LearnPlatform design, motion, or quality-review requests, use the project frontend-design, interaction-motion, marketing-showcase, and frontend-quality-review routing first; do not auto-run Impeccable context, init, document, hooks, or live workflows.
metadata:
  version: 4.3.1
---
