...
- AiStu 桌面端的教学逻辑和互动课件尚未迁入 Web 项目。

## 下一步

1. 盘点现有课程、知识点、练习、错题、复习、考试和 AI 事件，设计统一课程学习状态。
2. 明确 408 数据结构最小课程内容、一张试卷和可复用课件范围。
3. 设计课程库、课程总览与“开始学习”的首个跨层契约和失败用例。
4. 契约确认后实现首个 Web 闭环，暂不并行改造桌面端和全部管理页面。
