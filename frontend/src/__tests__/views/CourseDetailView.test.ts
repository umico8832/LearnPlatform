  ...
  beforeEach(() => {
    ...
    mockGetKnowledgeTree.mockResolvedValue({
      data: [
        ...
        {
          id: 36,
          name: 'FastArrayStack 的批量复制优化',
          description: '',
          contentKey: 'ods-fastarraystack-block-copy',
          children: [],
        },
        {
          id: 37,
          name: 'ArrayQueue 的循环数组表示',
          description: '',
